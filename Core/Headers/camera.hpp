...
public:
	...
	Camera(int lookType = Camera::TYPE_FREE_CAMERA, Vector3 position=Vector3(0,0,0), Vector3 pointToLookAt = Vector3(0, 0, 0), float near=-0.1f, float far=-10.0f, float fov=PI/2, float horizontalAngle=PI, float verticalAngle=0);
