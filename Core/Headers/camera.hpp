...
public:
	...
	Camera(Vector3 position=Vector3(0,0,0), float near=0.1, float far=10, float fov=3.1416/2, float horizontalAngle=0, float verticalAngle=0, int lookType=Camera::TYPE_FREE_CAMERA);
